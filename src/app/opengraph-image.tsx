  ...
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", background: "#f3efe5", color: "#13231d", padding: 68 }}>
      ...
      <div style={{ display: "flex", flexDirection: "column" }}>
        <div style={{ fontSize: 72, lineHeight: 1.02, letterSpacing: -3, fontWeight: 800, maxWidth: 940 }}>Arsanız, eviniz veya binanız için doğrudan yatırım değerlendirmesi.</div>
        <div style={{ marginTop: 26, fontSize: 28, color: "#55645d" }}>Beykoz ana odağımız • İstanbul’un seçili gelişim bölgeleri</div>
      </div>
